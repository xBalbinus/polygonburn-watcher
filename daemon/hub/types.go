...
import "github.com/xBalbinus/polygonburn-watcher/daemon/sql"

// Block type represents a single polygon Block.
type Block struct {
...
// TransactionReceipt type represents a single polygon Transaction.
