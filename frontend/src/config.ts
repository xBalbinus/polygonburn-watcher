...
export const PolygonNetworkOptions: {
  [key: string]: PolygonNetwork
} = {
  mainnet: { name: "Polygon", key: "mainnet", genesis: 12965000, chainId: 137 },
  staging: { name: "Mumbai", key: "staging", genesis: 12965000, chainId: 80001 },
};
...
export const defaultNetwork = PolygonNetworkOptions['mainnet']
